          ...
          >
            <Dialog.Panel className="min-w-content relative inline-block max-w-full align-middle transition-all ltr:text-left rtl:text-right">
              <button
                ...
                ref={cancelButtonRef}
                className="absolute top-4 flex justify-center items-center font-bold z-[60] h-10 w-10 rounded-full bg-gray-50 outline-none focus:outline-0 ltr:right-4 rtl:left-4"
              >
