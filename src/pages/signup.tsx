  ...
  return (
    <div className="bg-gray-900">
      <div className="flex min-h-screen items-center justify-center">
        {/* Main Card */}
        <div className="w-full max-w-md mt-20 rounded-3xl bg-gray-900 md:border border-gray-600 p-8 shadow-lg">
          {/* Logo */}
          <div className="mb-8">
          ...
          {step === 2 && (
            <form onSubmit={handleVerify} className="space-y-6">
              <p className="text-sm text-gray-400">
                Please enter the <strong>6-digit verification code</strong> sent
                to {phone}. The code is valid for 30 minutes.
              </p>
